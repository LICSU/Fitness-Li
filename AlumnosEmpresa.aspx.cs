...
{
    public partial class AlumnosEmpresa : System.Web.UI.Page
    {
        ...
        protected void BindGridView()
        {
            try
            {
                ...
                string cmd2 = "SELECT Usuario.UsuarioID as UsuarioId, "+
                            ...
                            " WHERE (PlanEmpresa.PlanActivo = 1) " + ViewState["sWhere"];
        ...
        protected void btnAsignarPlan_Click(object sender, EventArgs e)
        {
            ...
            if (dplClientes.SelectedValue != "" || dplPlan.SelectedValue != "")
            {
                ...
                FI = new DateTime(fechatemp.Year, fechatemp.Month, 1);
                FF = new DateTime(fechatemp.Year, fechatemp.Month + 1, 1).AddDays(-1);
                ...
                sSelectSQL = "SELECT COUNT(Usuario.UsuarioID) FROM PlanEmpresa INNER JOIN Usuario ON "
        ...
        protected int insertarPlanAcumulado(string cc2, string UsuarioID)
        {
            ...
            sSelectSQL = "INSERT INTO PlanAlumnoAcumulado (totalClases, disponiblesClases, UsuarioID, seleccionoClases)" +
                         " VALUES (" + Utilidades.SiEsNulo(cc2, "N") + ", " + Utilidades.SiEsNulo(cc2, "T") + ", " + Utilidades.SiEsNulo(UsuarioID, "N") + ", 0)";
            cn.Open();           
