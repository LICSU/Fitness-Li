<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarClases.aspx.cs" Inherits="LicsuWeb.Validado.ConsultarClases" %>
...
<uc3:ucMenu runat="server" ID="ucMenu" />
    ...
    <!-- Contenido pagina -->
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <h2 class="pull-left">Clases Asignadas</h2>
            ...
            <asp:UpdatePanel ID="upCrudGrid" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="90%" HorizontalAlign="Center"
                        ...
                        DataKeyNames="ClaseID" CssClass="footable" PageSize="20"
