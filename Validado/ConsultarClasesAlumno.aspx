<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarClasesAlumno.aspx.cs" Inherits="LicsuWeb.Validado.ConsultarClasesAlumno" %>
...
<uc3:ucMenu runat="server" ID="ucMenu" />
    ...
    <!-- Contenido pagina -->
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <h2 class="pull-left">Clases Actuales</h2>
