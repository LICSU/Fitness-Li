...
namespace LicsuWeb.Validado
{
    public partial class Autorizacion : System.Web.UI.Page
    {
        ...
        protected void BindGridView()
        {
            try
            {
                ...
                string cmd2 = "SELECT DISTINCT(dbo.Usuario.UsuarioCedula) as UsuarioCedula, (dbo.Usuario.UsuarioNombre+' '+dbo.Usuario.UsuarioApellido) as UsuarioNombre," +
                            "  AutorizacionID  as AutorizacionID, planAutorizacion.AutorizacionActivo as AutorizacionActivo" +
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            sSelect = "UPDATE planAutorizacion SET AutorizacionActivo = 1 WHERE AutorizacionID = "+AutorizacionID;
