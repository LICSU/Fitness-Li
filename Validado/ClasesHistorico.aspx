<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClasesHistorico.aspx.cs" Inherits="LicsuWeb.Validado.ClasesHistorico" %>
...
<title>Histórico de Clases</title>
...
<uc3:ucMenu runat="server" ID="ucMenu" />
    ...
    <!-- Contenido pagina -->
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <h2 class="pull-left">Histórico de Clases</h2>
