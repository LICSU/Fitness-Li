...
namespace LicsuWeb
{
    public partial class Calificaciones : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string CalificacionDescripcion = txtDescripcionEdit.Text;
            string CalificacionID = hCalificacionMod.Value;
            int iRes = 0;
            if (sonValidos("UPDATE"))
            {
                cn.Open();
                string sSelectSQL = "UPDATE Calificacion SET CalificacionNombre =" + Utilidades.SiEsNulo(CalificacionNombre, "T") + ", CalificacionDescripcion=" + Utilidades.SiEsNulo(CalificacionDescripcion, "T") + " WHERE CalificacionID=" + CalificacionID;
