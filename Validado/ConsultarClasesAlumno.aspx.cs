...
{
    public partial class ConsultarClasesAlumno : System.Web.UI.Page
    {
        ...
        protected void BindGridView()
        {
            ...
            {
                cn.Open();
                string cmd2 = "SELECT DISTINCT(Clase.ClaseID) as ClaseID, Clase.ClaseDescripcion as ClaseDescripcion, " +
                ...
                " ORDER BY ClasePlantilla.ClasePlantillaFecha DESC, ClasePlantilla.ClasePlantillaHora DESC";
