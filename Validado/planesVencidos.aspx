<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="planesVencidos.aspx.cs" Inherits="LicsuWeb.Validado.planesVencidos" %>
...
<!-- Contenido pagina -->
    ...
    <div class="col-md-12">
        <div class="col-md-4">
            <h2 class="pull-left">Planes Licsu a Vencer</h2>
        </div>        
            ...
            <ContentTemplate>
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="col-lg-6 col-xs-8">
                            <asp:DropDownList runat="server" ID="dplDias" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="dplDias_SelectedIndexChanged">
                                <asp:ListItem Text="Seleccione un Valor" Value=""></asp:ListItem>
                                <asp:ListItem Text="Entre 1 y 2 días" Value="1"></asp:ListItem>
                                <asp:ListItem Text="Entre 3 y 5 días" Value="2"></asp:ListItem>
                                <asp:ListItem Text="Entre 5 y 8 días" Value="3"></asp:ListItem>
                                <asp:ListItem Text="Más de 8 días" Value="4"></asp:ListItem>
                                <asp:ListItem Text="Entre 1 y 60 días" Value="5"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                ...
                <asp:GridView ID="GridView1" runat="server" Width="90%" HorizontalAlign="Center"
                    ...
                    <Columns>  
                        ...
                        <asp:TemplateField HeaderText="Vence el">
                            <ItemTemplate>
