<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Elementos.aspx.cs" Inherits="LicsuWeb.Validado.Elementos" EnableEventValidation="false" %>
...
<uc3:ucMenu runat="server" ID="ucMenu" />
    ...
    <!-- Contenido pagina -->
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <h2 class="pull-left">Listar Elementos</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <div class="col-lg-6 col-xs-8">
                                <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Elemento"></asp:TextBox>
                            </div>
