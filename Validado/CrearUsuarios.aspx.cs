    ...
    public partial class CrearUsuarios : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sPlanID = this.ddlPlan.SelectedValue;
                ...
                //{ 
                    ...
                    //prueba = "INSERT INTO USUARIOS(USUARIOID, USUARIONOMBRE " + parametros + " )  VALUES(" + sCedula + "," + valores + ")";
                    /** ************************* **/
                    if (sFormularioTipo == "1")
                    {
                        //Formulario LICSU
                        ...
                        if (txtRol.SelectedValue == "2") {
                            ...
                            //
                        //}
                        //else { if (sErr != "") { MostrarMsjModal(sErr, "ERR"); } else { MostrarMsjModal(sMsj, "ADV"); } }
                    }
                    else 
                    {
                        //Formulario Empresa                        
                            ...
                            else
                            {
                                ...
                                if (cedula == "")
                                {
                                    ...
                                    if (ddlTipoEmpleado.SelectedValue == "Contratado")
                                    {
                                        ...
                                        string mensaje = "El usuario " + sNombre + ", se ha registrado con éxito.\n Su tipo de empleado es: " + ddlTipoEmpleado.SelectedValue + ".\n" +
                    ...
                    if (sUsuarioPrueba > 0 && bandPrueba == true)
                    {
                        ...
                        //MostrarMsjModal(sSelectSQL, "");
                        Utilidades.EjeSQL(sSelectSQL, cn, ref Err, false);
                        sSelectSQL = "INSERT INTO PlanAlumnoAcumulado (totalClases, disponiblesClases, UsuarioID, seleccionoClases)" +
                                    "VALUES (1,1," + usuarioID + ",1)";
                        Utilidades.EjeSQL(sSelectSQL, cn, ref Err, false);
                        MostrarMsjModal("Se han registrado los datos exitosamente, para ingresar utilice su Cédula", "EXI");
                        //Response.Redirect("consultarUsuarios.aspx?registro=exito");
                    }
        ...
        {            
            ...
            //MostrarMsjModal("", "");
            string PlanID = Utilidades.EjeSQL("SELECT PlanID FROM [Plan] WHERE PlanNombre LIKE '%" + ClienteNombre + "%'", cn, ref Err, true);
            ...
            sSelectSQL = "Select PlanCantidadClases as MAXIMO from [Plan] Where PlanID = " + PlanID;
            ...
            if (iRes > 0)
            {
                ...
                iRes3 = insertarPlanAcumulado(cc2, UsuarioID);
                if (iRes3 > 0)
                {
                    band = true;
                }
        ...
        protected int insertarPlanAcumulado(string cc2, string UsuarioID)
        {
            ...
            int res = 0;
            sSelectSQL = "INSERT INTO PlanAlumnoAcumulado (totalClases, disponiblesClases, UsuarioID)" +
                         " VALUES (" + Utilidades.SiEsNulo(cc2, "N") + ", " + Utilidades.SiEsNulo(cc2, "T") + ", " + Utilidades.SiEsNulo(UsuarioID, "N") + ")";
            try 
            {
                cn.Open();
