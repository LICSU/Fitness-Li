<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpleadosActivos.aspx.cs" Inherits="LicsuWeb.Validado.EmpleadosActivos" EnableEventValidation="false" %>
...
<uc3:ucMenu runat="server" ID="ucMenu" />
    ...
    <!-- Contenido pagina -->
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <h2 class="pull-left">Empleados Activos</h2>
        ...
        <asp:UpdatePanel ID="upCrudGrid" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center"
                    ...
                    onpageindexchanging="GridView1_PageIndexChanging" EmptyDataText="No existen empleados activos." >
                    <Columns>     
