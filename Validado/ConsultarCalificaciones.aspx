<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarCalificaciones.aspx.cs" Inherits="LicsuWeb.Validado.ConsultarCalificaciones" %>
    ...
    <div id="page-wrapper" > -->
        ...
        <!-- Contenido pagina -->
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-4">
                    <h2 class="pull-left">Consultar Alumno</h2>
                    </div>               
            ...
            <asp:UpdatePanel ID="upCrudGrid" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="90%" HorizontalAlign="Center"
                        ...
                        <Columns>
                            <asp:ButtonField CommandName="consultarAlumno"
                                ButtonType="Button" Text="Consultar" HeaderText="Consultar">
