<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Niveles.aspx.cs" Inherits="LicsuWeb.Validado.Niveles" EnableEventValidation="false" %>
...
<uc3:ucMenu runat="server" ID="ucMenu" />
    ...
    <!-- Contenido pagina -->
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <h2 class="pull-left">Listar Niveles</h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="col-lg-6 col-xs-8">
                                                <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Nivel"></asp:TextBox>
                                            </div>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" Width="90%" HorizontalAlign="Center"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Activa">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="Activo" runat="server" Enabled="false" Checked='<%# Eval("NivelActivo") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>                                                            
                                        </Columns>
                                    </asp:GridView>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h3 id="editModalLabel">Modificar Nivel</h3>
                                            ...
                                            <ContentTemplate>
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-xs-2"></div>
                                                            <label class="col-xs-2 control-label">Activa: </label>
                                                                <div class="col-xs-6">
