...
{
    public partial class BusquedaPorAlumno : System.Web.UI.Page
    {
        ...
        protected void busqueda(string busqueda) 
        {
            if (Utilidades.EjeSQL("SELECT UsuarioCedula FROM Usuario WHERE UsuarioCedula = '" + busqueda+"'", cn, ref Err, true) != "")
            {
                ...
                if (clienteid == "1")
                {
                    ...
                    lblEstado.Text += Utilidades.EjeSQL(SselectSQL, cn, ref Err, true);
                }
                else
                {
                ...
                try
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        lblClasesActivas.Text = "Clases Activas: " + dr["ClasesActivas"].ToString();
        ...
        protected void BindGridView()
        {
            try
            {
                ...
                string cmd2 = "SELECT dbo.Clase.ClaseDescripcion as ClaseDescripcion, "+
                            ...
                            " (dbo.Reserva.FechaReserva+''+dbo.Reserva.HoraReserva) as FechaReserva, "+
