<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnviarCorreos.aspx.cs" Inherits="LicsuWeb.Validado.EnviarCorreos" %>
        ...
        <!-- Contenido pagina -->
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                            <h2 class="pull-left">Enviar Correos</h2>
                            </div>               
            ...
            <div class="col-md-12">
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="col-lg-6">
                            <asp:Button ID="btnEnvioInd" runat="server" Text="Correo Individual"  CssClass="btn btn-purple" OnClick="btnEnvioInd_Click" />
                        </div>
                        <div class="col-lg-3"></div>            
                    </ContentTemplate>
                </asp:UpdatePanel>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h3 id="editModalLabel">Correo Individual</h3>
                            ...
                            <asp:UpdatePanel ID="upEdit" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <asp:Button ID="btnEnviar" runat="server" Text="Enviar" CssClass="btn btn-purple" OnClick="btnEnviar_Click" />
