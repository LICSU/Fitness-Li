...
{
    public partial class AsignarPlanes : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName.Equals("agregarPago"))
            {
                ...
                txtPlanAlumnoAdd.Text = (gvrow.FindControl("PlanNombre") as Label).Text;
        ...
        protected void Pagar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (DeudaAnterior != "")
                {
                    ...
                    if (deudaAnt == 0)
                    {
                        if (double.Parse(Monto) > double.Parse(Deuda))
                        {
                        ...
                        else
                        {
                            ...
                            if (sonValidos("Pagos_Insert"))
                            {
                                ...
                                sSelectSQL = "INSERT INTO PlanPago" +
                                            ...
                                            ", CONVERT(DATETIME, '" + FechaFactura + "', 103)," + Utilidades.SiEsNulo(Monto, "N") +
                                            ",SYSDATETIME() , 1)";
                                ...
                                {
                                    limpiarCampos();
                                    double deudaNueva = (double.Parse(Deuda) - double.Parse(Monto));
                                    double positivoNuevo = (double.Parse(Positivo) + double.Parse(Monto));
                                    cn.Open();
