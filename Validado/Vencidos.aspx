<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vencidos.aspx.cs" Inherits="LicsuWeb.Validado.Vencidos" %>
...
<!-- Contenido pagina -->
    ...
    <div class="col-md-12">
        <div class="col-md-4">
            <h2 class="pull-left">Planes Vencidos</h2>
        </div>        
        ...
        <asp:UpdatePanel ID="upCrudGrid" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView1" runat="server" Width="90%" HorizontalAlign="Center"
                    ...
                    DataKeyNames="UsuarioCedula" CssClass="footable" PageSize="20"
