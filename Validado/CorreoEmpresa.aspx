<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorreoEmpresa.aspx.cs" Inherits="LicsuWeb.Validado.CorreoEmpresa" %>
...
<uc3:ucMenu runat="server" ID="ucMenu" />
    ...
    <!-- Contenido pagina -->
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <h2 class="pull-left">Correo Empresa</h2>
                    ...
                    <div class="modal-body">
                        ...
                        <ContentTemplate>
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <asp:DropDownList  ID="dplEmpresa" runat="server" ClientIDMode="Static" CssClass="form-control"></asp:DropDownList>                                                                                                  
                                </div>
                            </div>                          
                            <div class="form-group">
