<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoCalificacion.aspx.cs" Inherits="LicsuWeb.Validado.TipoCalificacion" EnableEventValidation="false" %>
...
<title>Tipo de Calificación</title>
...
<uc3:ucMenu runat="server" ID="ucMenu" />
    ...
    <!-- Contenido pagina -->
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <h2 class="pull-left">Tipo de Calificación</h2>
                            ...
                            <asp:UpdatePanel ID="upCrudGrid" runat="server">
                                <ContentTemplate>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="col-lg-6 col-xs-8">
                                                <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Tipo"></asp:TextBox>
                                            </div>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" Width="90%" HorizontalAlign="Center"
                                        ...
                                        DataKeyNames="NivelID" CssClass="footable" PageSize="20"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h3 id="H1">Agregar Tipo de Calificación</h3>
                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h3 id="editModalLabel">Modificar Tipo de Calificación</h3>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h3 id="delModalLabel">Eliminar Tipo de Calificación</h3>
                                        </div>
