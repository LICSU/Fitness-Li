    ...
    public partial class Planes : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (sBuscar != "")
                { ViewState["sWhere"] = " WHERE PlanNombre LIKE '%" + sBuscar + "%'"; }
                else
                { ViewState["sWhere"] = ""; }
                BindGridView();
            }
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            bool Activo = chkActivoAdd.Checked;
            ...
            if (sonValidos("INSERT"))
            {
                ...
                sSelectSQL = "INSERT INTO [Plan] (PlanID, PlanNombre, PlanDescripcion, PlanFechaInicio, PlanFechaFin, "+
                             " PlanUsuarioRegistro, PlanFechaRegistro,PlanActivo, clasesComplemen, PlanCosto, clasesRegulares)" +
                             ...
                             " ,1,SYSDATETIME(),'" + Activo + "'," + Utilidades.SiEsNulo(ClasesComplemen, "T") + "," + Utilidades.SiEsNulo(Costo, "T") + "," + Utilidades.SiEsNulo(ClasesRegulares, "T") + ")";
        ...
        protected void Editar_Click(object sender, EventArgs e)
        {
            ...
            if (sonValidos("UPDATE"))
            {
                ...
                string sSelectSQL = "UPDATE [Plan] SET PlanNombre =" + Utilidades.SiEsNulo(Nombre, "T") +
                                    ...
                                    ", PlanCosto = " + Utilidades.SiEsNulo(Costo, "T") + " WHERE PlanID=" + PlanID;
                SqlCommand addCmd = new SqlCommand(sSelectSQL, cn);
                try { iRes = addCmd.ExecuteNonQuery(); }
