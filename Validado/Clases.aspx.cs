...
namespace LicsuWeb.Validado
{
    ...
    public partial class Clasees : System.Web.UI.Page
    {
        ...
        protected void BindGridView()
        {
            ...
            {               
                ...
                string cmd2 = "SELECT (SELECT TipoCalificacionDescripcion FROM TipCalificacion n WHERE n.TipoCalificacionID = c.TipoCalificacionID) as TipoCalificacion," +
                              ...
                              " c.ClaseTipo as Tipo, c.ClaseUnidad as Unidad,c.TiempoCambio as TiempoCambio, c.ClaseIntervalo as Intervalo, c.ClaseSensor as Sensor FROM Clase c " + ViewState["sWhere"];
            ...
            if (sonValidos("UPDATE"))
            {
                ...
                if (plhOrdenEdit.Visible == true)
                {
                    sSelectSQL = "UPDATE Clase SET ClaseDescripcion =" + Utilidades.SiEsNulo(ClaseDescripcion, "T") + ", " +
                                ...
                                "' ,ClaseFilas = " + ClaseFilas + ", ClaseColumnas = " + ClaseColumnas + ", ClaseIntervalo = " + Intervalo + 
                                ", ClaseSensor = " + Sensor + ", TiempoCambio = " + Break + " WHERE ClaseID=" + ClaseID;
                }
                else {
                    sSelectSQL = "UPDATE Clase SET ClaseDescripcion =" + Utilidades.SiEsNulo(ClaseDescripcion, "T") + ", " +
                                " ClaseUnidad = " + Utilidades.SiEsNulo(UnidadID, "N") + ", TipoCalificacionID = " + Utilidades.SiEsNulo(TipoCalificacionID, "N") + ", " +
                                " ClaseTipo = " + Utilidades.SiEsNulo(TipoID, "T") + " ,ClaseActiva='" + ClaseActiva +
                                "' , ClaseIntervalo = " + Intervalo + " , ClaseSensor = " + Sensor + ", TiempoCambio = "+Break+" WHERE ClaseID=" + ClaseID;
                }
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                cn.Open();
                string sSelectSQL = "INSERT INTO Clase (ClaseDescripcion, ClaseActiva,ClaseFechaRegistro,ClaseUsuarioRegistro, ClaseTipo, ClaseUnidad,TipoCalificacionID,ClaseFilas,ClaseColumnas,ClaseIntervalo,ClaseSensor,TiempoCambio) " +
                              ...
                              ", " + Utilidades.SiEsNulo(Sensor, "N") + ", "+Utilidades.SiEsNulo(Break, "N")+")";
